...
class NotificationToAmendDeclarationSpec extends BaseSpec with GivenWhenThen {
  ...
  Feature("End to End Journey for IE022 - Notification to Amend Declaration") {
    ...
    Scenario("02 End to end journey for viewing errors from a rejected declaration amendment after MRN allocation") {
      Given("I login with ID 1234567890")
      andILoginWithIDX("1234567890")
    ...
    Scenario("02 End to end journey for when no function errors exist from a rejected declaration amendment after MRN allocation") {
      Given("I login with ID 1234567890")
      andILoginWithIDX("1234567890")
